...
function useUncontrolledProp(propValue, defaultValue, handler) {
  var wasPropRef = (0, import_react5.useRef)(propValue !== void 0);
  var _useState = (0, import_react5.useState)(defaultValue), stateValue = _useState[0], setState = _useState[1];
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react5.useCallback)(function(value) {
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React3.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var Popover = React5.forwardRef(({
  ...
  return (0, import_jsx_runtime4.jsxs)("div", {
    ...
    className: (0, import_classnames2.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Overlay2 = React10.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime7.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React10.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React11.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime10.jsxs)(import_jsx_runtime9.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react27.cloneElement)(children, triggerProps), (0, import_jsx_runtime8.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
